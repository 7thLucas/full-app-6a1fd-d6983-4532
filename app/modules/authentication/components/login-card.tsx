...
export function LoginCard() {
  ...
  const tagline = loading ? "Coffee Shop Operations, Simplified" : (config?.tagline ?? "Coffee Shop Operations, Simplified");
      ...
      <Card className="w-full max-w-sm shadow-lg rounded-2xl border-0">
        <CardHeader className="space-y-3 text-center pb-4">
          ...
          <div>
            ...
            <CardDescription className="text-sm mt-1">{tagline}</CardDescription>
          </div>
        </CardHeader>
        ...
        <Form method="post">
          ...
          <CardFooter className="flex flex-col gap-3 pt-2">
            ...
            <p className="text-center text-sm text-muted-foreground">
              ...
              <Link to="/auth/register" className="font-medium underline underline-offset-4" style={{ color: secondary }}>
                Create one
              </Link>
            </p>
          </CardFooter>
